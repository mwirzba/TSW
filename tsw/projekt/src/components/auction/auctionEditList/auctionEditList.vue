    ...
    <div class="auction-container">
        <div class="auction-list" v-if="logged && auctions.length > 0">
            <div v-for="(auction,i) in auctions" :key="auction+i" class="auction-element">
                ...
                <router-link :to="{ name: 'editAuction' , params: { auctionToEdit: auction.auctionName  , editMode: true } }">Edit</router-link>
            </div>
        </div>
    </div>
</template>

<script src="./auctionEditList.js">

</script>

<style lang="scss" src="./auctionEditList.scss">
